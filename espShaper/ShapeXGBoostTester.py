...
are extracted and fed to the pretrained model for predictions showing confidence with xgboost model"""
import serial
import time
import numpy as np
import pandas as pd
...
model = joblib.load("Trained_Shapes_XGBoost.joblib")
feature_names = joblib.load("feature_Shapes_XGBoost.joblib")
